...
const form = useForm({
  ...
  main_description: props.questionnaire.main_description,
  sub_description: props.questionnaire.sub_description,
  annotation: props.questionnaire.annotation,
  questionnaire_photo_path: props.questionnaire.questionnaire_photo_path,
  status: Boolean(props.questionnaire.status),
  start_date: props.questionnaire.start_date,
  start_time: props.questionnaire.start_time,
  end_date: props.questionnaire.end_date,
  end_time: props.questionnaire.end_time,
});
...
const update = () => {
  if (Object.keys(form.errors).length === 0) {
    ...
    form.post(route("admin.questionnaire.store", questionnaire.id), {
      onFinish: () => {
      ...
      <div class="flex sm:flex-row items-center justify-between">
        ...
        <Breadcrumb
          :items="[
            ...
            { name: 'Edit', url: route('admin.questionnaire.edit', questionnaire.id) },
          ]"
        />
      </div>
    </template>
    ...
    <QuestionnaireLayout>
      <div class="flex justify-between p-5">
        <div class="w-1/2 flex flex-col gap-2">
          <PageSubTitle title="アンケート編集画面" />
          <PageDescription
            description="アンケートの編集することができます。"
          />
        </div>
