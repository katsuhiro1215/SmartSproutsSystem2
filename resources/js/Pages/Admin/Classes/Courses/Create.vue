...
// Form
const form = useForm({
  lesson_id: props.defaultLessonId,
  course_category_id: props.defaultCourseCategoryId,
  name: "",
  description: "",
  course_photo_path: "",
  status: true,
      ...
      <div class="flex sm:flex-row items-center justify-between">
        ...
        <Breadcrumb
          :items="[
            ...
            { name: 'Create', url: route('admin.course.create') },
          ]"
        />
      </div>
    </template>
    ...
    <ClassLayout>
      <div class="flex justify-between p-5">
        <div class="w-1/2 flex flex-col gap-2">
          <PageSubTitle title="コース新規作成画面" />
          <PageDescription description="コースを新規作成する画面です。" />
        </div>
