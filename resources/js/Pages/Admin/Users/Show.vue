...
const tabs = [
  { name: "アカウント情報", key: "userInfo" },
  { name: "住所情報", key: "userAddressInfo" },
      ...
      <div class="flex sm:flex-row items-center justify-between">
        ...
        <Breadcrumb
          :items="[
            ...
            { name: 'Show', url: route('admin.user.show', user.id) },
          ]"
        />
      </div>
    </template>
    ...
    <UserLayout>
      <div class="flex justify-between p-5">
        <div class="flex flex-col gap-2">
          <PageSubTitle title="ユーザー詳細" />
          <PageDescription description="ユーザー詳細を表示する画面です。" />
        </div>
        ...
        <Card class="w-full lg:w-2/3">
          <template #content>
            <div class="w-full space-y-6">
              ...
              <div class="w-full space-y-4" v-else-if="activeTab === 'userAddressInfo'">
                <UserAddressInfo :user="user" :userAddresses="userAddresses" />
              </div>
              <div class="w-full space-y-4" v-else-if="activeTab === 'studentInfo'">
                <StudentInfo :students="students" />
              </div>
              <div class="w-full space-y-4" v-else-if="activeTab === 'guardianInfo'">
