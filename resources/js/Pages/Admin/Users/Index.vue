...
const tabs = [
  ...
  { name: "deletedUsers", label: "削除済ユーザー一覧" },
];
    ...
    <UserLayout>
      <div class="flex justify-between p-5">
        <div class="flex flex-col gap-2">
          <PageSubTitle title="ユーザー一覧" />
          <PageDescription description="ユーザー一覧を表示する画面です。" />
        </div>
        <div class="flex justify-end items-center gap-2">
          <PrimaryButton :href="route('admin.user.create')" buttonType="indigo"
            ><Plus />ユーザー新規作成</PrimaryButton
          >
