...
const form = useForm({
  ...
  lastname_kana: props.student.lastname_kana,
  firstname_kana: props.student.firstname_kana,
  student_photo_path: props.student.student_photo_path,
  birth: props.student.birth,
  gender: props.student.gender,
  blood: props.student.blood,
  mobile_number: props.student.mobile_number,
  mobile_number_relationship: props.student.mobile_number_relationship,
  personal_history: props.student.personal_history,
  membership_option_id: props.student.membership_option_id,
  member_no: props.student.member_no,
  serial_no: props.student.serial_no,
  permission_photo: Boolean(props.student.permission_photo),
  permission_dm: Boolean(props.student.permission_dm),
...
const update = () => {
  if (Object.keys(form.errors).length === 0) {
    ...
    form.post(route("admin.student.update", student.id), {
      onFinish: () => {
      ...
      <div class="flex sm:flex-row items-center justify-between">
        ...
        <Breadcrumb
          :items="[
            ...
            { name: 'Edit', url: route('admin.student.edit', student.id) },
          ]"
        />
      </div>
    </template>
    ...
    <UserLayout>
      <div class="flex justify-between p-5">
        <div class="flex flex-col gap-2">
          <PageSubTitle title="生徒編集画面" />
          <PageDescription description="生徒を編集することができます。" />
        </div>
