      ...
      <div class="flex sm:flex-row items-center justify-between">
        ...
        <Breadcrumb
          :items="[
            ...
            { name: 'Create', url: route('admin.organization.create') },
          ]"
        />
      </div>
    </template>
    ...
    <SettingLayout>
      <div class="flex justify-between">
        <div class="flex flex-col gap-2">
          <PageSubTitle title="組織新規作成画面" />
          <PageDescription
            description="組織を新規作成することができます。法人のみ追加登録することができます。"
          />
        </div>
                    ...
                    <div class="flex flex-col gap-4">
                      <FormGroup>
                        ...
                        <ImageUpload
                          ...
                          @change="form.organization_photo_path = $event.target.files[0]"
                        />
                        <InputError
                          class="mt-2"
                      ...
                      <FormGroup>
                        ...
                        <ImageUpload
                          ...
                          @change:modelValue="
                            (file) =>
                              handleFileUpload(file, 'organization_logo_path')
                          "
                        />
                        <InputError
                          class="mt-2"
