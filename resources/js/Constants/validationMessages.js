...
export default {
    ...
    event: {
        name: "イベント名は50文字以内で入力してください。",
        description: "イベントの説明は1000文字以内で入力してください。",
    },
    questionnaire: {
        name: "アンケート設問名は50文字以内で入力してください。",
        main_description: "アンケートの設問内容は800文字以内で入力してください。",
        sub_description: "アンケートの補足説明は800文字以内で入力してください。",
        annotation: "アンケートの注釈は600文字以内で入力してください。",
    }
};